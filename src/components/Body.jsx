    ...
    return (
        ...
        <div className="inset-0 -z-10  items-center px-5 py-24 bg-black flex flex-col">
            {props.paper.map((question, index) => {
                return <div key={uuidv4} className='box-border bg-blue-900 border-2 border-green-500 rounded-[22px] w-[110%] lg:w-[95%] flex flex-col justify-center items-center my-[11px] p-4 min-h-[322px]'>
